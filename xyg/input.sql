...
CREATE TABLE `input_craft_standard_card` (
    ...
    `card_id` VARCHAR(255)     NOT NULL     COMMENT '产品工艺卡ID',
    `standard_craft_card_id`  VARCHAR(255)     NOT NULL     COMMENT '标准工艺卡ID',
    `product_ingredients_card_id` VARCHAR(255)     NOT NULL     COMMENT '生产配料卡ID',
...
CREATE TABLE `input_modify_record`  (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_modify_record';
...
CREATE TABLE `input_process_craft`  (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_process_craft';
...
CREATE TABLE `input_craft_curve` (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_craft_curve';
...
CREATE TABLE `input_craft_curve_point`  (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_craft_curve_point';
...
CREATE TABLE `input_config_craft_fast_forging`  (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_config_craft_fast_forging';
...
CREATE TABLE `input_config_craft_fast_forging_fire_order`  (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_config_craft_fast_forging_fire_order';
...
CREATE TABLE `input_craft_diameter_forging`  (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_craft_diameter_forging';
...
CREATE TABLE `input_craft_finishing`  (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_craft_finishing';
...
CREATE TABLE `input_craft_tempering`  (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_craft_tempering';
...
CREATE TABLE `input_craft_package_store` (
    ...
    -- CONSTRAINT `foreign_key_name` FOREIGN KEY (`field1`) REFERENCES `foreign_table`(`foreign_key`)
    -- INDEX (``)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic COMMENT = 'input_craft_package_store';
