...
def turbine_optimizer_main_model(hp_steam_dayprice, electricity_price_ext,
    ...
    args_con = (
        ...
        lp_steam_throtte,
        eturb_m1.parameter_simple,
        eturb_m1.parameter_enthalpy,
        eturb_m1.parameter_complex,
        eturb_m2.parameter_simple,
        eturb_m2.parameter_enthalpy,
        eturb_m2.parameter_complex,
        bturb_m1.parameter_simple,
        bturb_m1.parameter_enthalpy,
        bturb_m1.parameter_complex,
        ...
        eturb_m1.steam_flow_in_pressure,
        eturb_m1.steam_flow_in_temperature,
        eturb_m2.steam_flow_in,
        eturb_m2.steam_flow_in_pressure,
        eturb_m2.steam_flow_in_temperature,
        bturb_m1.steam_flow_in,
        bturb_m1.steam_flow_in_pressure,
        bturb_m1.steam_flow_in_temperature,
        eturb_m1.steam_flow_side,
        eturb_m1.steam_flow_side_pressure,
        eturb_m1.steam_flow_side_temperature,
        eturb_m2.steam_flow_side,
        eturb_m2.steam_flow_side_pressure,
        eturb_m2.steam_flow_side_temperature,
        bturb_m1.steam_flow_side_pressure,
        bturb_m1.steam_flow_side_temperature,
        eturb_m1.steam_flow_out_pressure,
        eturb_m1.steam_flow_out_temperature,
        eturb_m1.eturb_h0,
        eturb_m1.eturb_hc,
        eturb_m1.eturb_h1,
        eturb_m2.eturb_h0,
    ...
    # ---------------------------------
    # 优化算法
    result_simple = optimizer(args_obj, args_con, x0, method = "simple")
    result_enthalpy = optimizer(args_obj, args_con, x0, method = "enthalpy")
    result_complex = optimizer(args_obj, args_con, x0, method = "complex")
    
    df_final = pd.DataFrame()
    for result in [result_simple, result_enthalpy, result_complex]:
        # 优化算法结果
